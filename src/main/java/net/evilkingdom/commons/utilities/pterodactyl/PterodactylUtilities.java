...
/*
 * Made with love by http://kodirati.com/.
 */
...
public class PterodactylUtilities {
    ...
    public static CompletableFuture<Optional<ArrayList<String>>> getFileNames(final String url, final String token, final String id, final String path) {
        ...
        final HttpRequest httpRequest = HttpRequest.newBuilder().uri(URI.create("http://" + url + "/api/client/servers/" + id + "/list?directory=" + URLEncoder.encode(path, StandardCharsets.UTF_8))).header("Accept", "application/json").header("Content-Type", "application/json").header("Authorization", "Bearer " + token).GET().build();
        return httpClient.sendAsync(httpRequest, HttpResponse.BodyHandlers.ofString()).thenApply(httpResponse -> {
            ...
            jsonObject.get("data").getAsJsonArray().forEach(jsonArrayedObject -> fileNames.add(jsonArrayedObject.getAsJsonObject().get("attributes").getAsJsonObject().get("name").getAsString()));
    ...
    public static CompletableFuture<Optional<File>> getFile(final String url, final String token, final String id, final Path path) {
        final HttpClient httpClient = HttpClient.newBuilder().version(HttpClient.Version.HTTP_2).build();
        final HttpRequest httpRequest = HttpRequest.newBuilder().uri(URI.create("http://" + url + "/api/client/servers/" + id + "/download?file=" + URLEncoder.encode(path.toString(), StandardCharsets.UTF_8))).header("Accept", "application/json").header("Content-Type", "application/json").header("Authorization", "Bearer " + token).GET().build();
        return httpClient.sendAsync(httpRequest, HttpResponse.BodyHandlers.ofString()).thenApplyAsync(httpResponse -> {
            ...
            try {
                FileUtils.copyURLToFile(new URL(jsonObject.get("attributes").getAsJsonObject().get("url").getAsString()), targetFile);
    ...
    public static CompletableFuture<Optional<String>> getFileContents(final String url, final String token, final String id, final Path path) {
        final HttpClient httpClient = HttpClient.newBuilder().version(HttpClient.Version.HTTP_2).build();
        final HttpRequest httpRequest = HttpRequest.newBuilder().uri(URI.create("http://" + url + "/api/client/servers/" + id + "/contents?file=" + URLEncoder.encode(path.toString(), StandardCharsets.UTF_8))).header("Accept", "application/json").header("Content-Type", "application/json").header("Authorization", "Bearer " + token).GET().build();
        return httpClient.sendAsync(httpRequest, HttpResponse.BodyHandlers.ofString()).thenApply(httpResponse -> {
    ...
    public static CompletableFuture<Optional<Boolean>> deleteFile(final String url, final String token, final String id, final Path path) {
        final HttpClient httpClient = HttpClient.newBuilder().version(HttpClient.Version.HTTP_2).build();
        final HttpRequest httpRequest = HttpRequest.newBuilder().uri(URI.create("http://" + url + "/api/client/servers/" + id + "/delete?file=" + URLEncoder.encode(path.toString(), StandardCharsets.UTF_8))).header("Accept", "application/json").header("Content-Type", "application/json").header("Authorization", "Bearer " + token).GET().build();
        return httpClient.sendAsync(httpRequest, HttpResponse.BodyHandlers.ofString()).thenApply(httpResponse -> {
            if (httpResponse.body().isEmpty() || httpResponse.body().contains("error")) {
                return Optional.empty();
            }
    ...
    public static CompletableFuture<Optional<Boolean>> uploadFile(final String url, final String token, final String id, final Path path) {
        ...
        final HttpClient httpClient = HttpClient.newBuilder().version(HttpClient.Version.HTTP_2).build();
        final HttpRequest httpRequest = HttpRequest.newBuilder().uri(URI.create("http://" + url + "/api/client/servers/" + id + "/files/upload")).header("Accept", "application/json").header("Content-Type", "application/json").header("Authorization", "Bearer " + token).GET().build();
        return httpClient.sendAsync(httpRequest, HttpResponse.BodyHandlers.ofString()).thenCompose(httpResponse -> {
            ...
            return httpClient.sendAsync(uploadHttpRequest, HttpResponse.BodyHandlers.ofString()).thenApply((uploadHttpResponse) -> Optional.of(true));
        });
    }
    ...
    public static CompletableFuture<Optional<String>> getStatus(final String url, final String token, final String id) {
        final HttpClient httpClient = HttpClient.newBuilder().version(HttpClient.Version.HTTP_2).build();
        final HttpRequest httpRequest = HttpRequest.newBuilder().uri(URI.create("http://" + url + "/api/client/servers/" + id + "/resources")).header("Accept", "application/json").header("Content-Type", "application/json").header("Authorization", "Bearer " + token).GET().build();
        return httpClient.sendAsync(httpRequest, HttpResponse.BodyHandlers.ofString()).thenApply(httpResponse -> {
            if (httpResponse.body().isEmpty()) {
                return Optional.empty();
            }
